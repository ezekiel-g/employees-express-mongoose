...
const employeeSchema = new mongoose.Schema(
  {
    firstName: {
      ...
      match: [
        /^[A-Za-zÀ-ÿ ''-]{1,100}$/,
        'First name can be a maximum of 100 characters and can contain only ' +
          'letters, apostrophes, hyphens, and spaces between words',
      ],
    },
    lastName: {
      type: String,
      ...
      match: [
        /^[A-Za-zÀ-ÿ ''-]{1,100}$/,
        'Last name can be a maximum of 100 characters and can contain only ' +
          'letters, apostrophes, hyphens, and spaces between words',
      ],
    },
    title: {
      ...
      match: [
        /^[A-Za-zÀ-ÿ ''-]{1,100}$/,
        'Job title can be a maximum of 100 characters and can contain only ' +
          'letters, apostrophes, hyphens, and spaces between words',
      ],
    },
    departmentId: {
